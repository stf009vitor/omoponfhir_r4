...
public class OmopEncounter extends BaseOmopResource<Encounter, VisitOccurrence, VisitOccurrenceService> {
	...
	public Encounter constructFHIR(Long fhirId, VisitOccurrence visitOccurrence) {
		...
		if (reason_visit_text != null && reason_visit_text.length() != 0){
			...
			if (reason_visit_system == null || reason_visit_text.length() == 0){
...
//		}
		...
		logger.error("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF");
		if (visitOccurrence.getCareSite() != null) {
			logger.error("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
